"""
Visualization tools for maneuver detection results.

Generates plots of orbital element evolution with detected maneuvers
highlighted. Designed for both interactive analysis (Jupyter) and
report generation (saved PNGs).
"""
...
def generate_report(
    ...
    summary = (
        f"# Orbital Sentinel — Maneuver Report\n"
