"""
Orbital Sentinel CLI.

Usage:
    orbital-sentinel scan --norad-id 25544 --days 90
    orbital-sentinel scan --file data/starlink_tles.txt
    orbital-sentinel constellation --name starlink --days 30
    orbital-sentinel report --file data/detections.csv
"""
...
def main(verbose: bool):
    """Orbital Sentinel — Satellite maneuver detection from TLE history."""
...
def scan(
    ...
    """Scan a single satellite for maneuvers."""
...
def constellation(
    ...
    console.print(
        Panel(
            ...
            f"Satellites with maneuvers: {n_sats}/{len(ids)}\n"
